...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { high: @price.high, low: @price.low, open: @price.open } }, as: :json
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { high: @price.high, low: @price.low, open: @price.open } }, as: :json
    assert_response 200
  end
